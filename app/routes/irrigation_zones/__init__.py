...
irrigation_zones_bp.route('schedule', methods=['DELETE'])(ZoneController.delete_schedule)
...
irrigation_zones_bp.route('/irrigation-types', methods=['GET'])(ZoneController.irrigation_types_list)
irrigation_zones_bp.route('/irrigation-types/<type_id>', methods=['GET'])(ZoneController.irrigation_types_show)