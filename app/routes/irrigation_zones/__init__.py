...
irrigation_zones_bp.route('schedule', methods=['DELETE'])(ScheduleController.delete_schedule)
irrigation_zones_bp.route('schedule', methods=['PATCH'])(ScheduleController.update_schedule)
irrigation_zones_bp.route('/schedule-irrigation', methods=['POST'])(ScheduleController.schedule_irrigation)
...
irrigation_zones_bp.route('/<zone_id>/schedules', methods=['GET'])(ScheduleController.schedule_irrigation_list)