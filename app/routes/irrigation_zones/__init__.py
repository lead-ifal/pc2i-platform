...
irrigation_zones_bp.route('update', methods=['PATCH'])(ZoneController.update)
...
irrigation_zones_bp.route('update-schedule', methods=['PATCH'])(ZoneController.update_schedule)
